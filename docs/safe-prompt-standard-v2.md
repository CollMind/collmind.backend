...
### Push hatası durumunda
```
ÖNEMLI: staging'e push reddedilirse alternatif branch'e geçme.
Dur, hatayı raporla. Doğru akış: feature/* → PR → staging
```
...
6. Push hatası: staging'e push reddedilirse alternatif branch denenmez — dur ve raporla.
...
| v2.1     | Mart 2026  | İki repo mimarisi, koordineli sıralı merge, push hatası kuralı |
